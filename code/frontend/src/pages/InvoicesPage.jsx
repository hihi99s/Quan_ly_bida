    ...
    <div className="space-y-6 animate-in">
      ...
      {selectedInvoice && (
        <div className="fixed inset-0 z-50 bg-black/80 flex items-center justify-center p-4 animate-in">
          <div className="bg-white w-full max-w-md rounded-lg shadow-2xl overflow-hidden text-slate-800">
            <div className="p-8">
              ...
              <div className="space-y-3 mb-6 font-mono text-sm leading-relaxed">
                ...
                <div className="flex justify-between"><span>Bàn:</span> <strong>{selectedInvoice.session?.table?.name || '---'}</strong></div>
                <div className="flex justify-between"><span>Nhân viên:</span> <span>{selectedInvoice.staff?.username || 'Admin'}</span></div>
              ...
              <div className="flex gap-2">
                <button onClick={() => setSelectedInvoice(null)} className="flex-1 py-3 bg-slate-200 text-slate-700 font-bold rounded hover:bg-slate-300">Đóng</button>
                <button onClick={() => window.print()} className="flex-1 py-3 bg-blue-600 text-white font-bold rounded hover:bg-blue-700 flex justify-center items-center gap-2">
                  🖨 In Bill
                </button>
              </div>
            </div>
